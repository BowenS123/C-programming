...
int main( void )
{
	...
	(void)scanf( "%lld", &aantalSeconden );

	// Bereken het aantal dagen
	dagen = aantalSeconden / (24 * 3600); // Bereken aantal dagen m.b.v. aantalSeconden
	rest = aantalSeconden % (24 * 3600);  // Bereken de restwaarde dat niet in een dag past
	printf( "Dagen = %d\n", dagen );
