...
Het getal bekom je door alfa met beta te vermenigvuldigen, daar gamma bij te tellen, het geheel te delen door delta. Gebruik dat voor een modulo/rest operatie met het verschil van gamma min delta.
*/
#include <stdio.h>
